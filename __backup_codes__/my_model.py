...
# keras_model_path = r'E:\__MyProjects\Shadow_MAP_Detection\Version_6\Code\Python\NPA_detection_CNN\logs\model_0_192_5.3282.hdf5'
# custom_objects = {'jaccards_loss': jaccards_loss}
# my_model_tools.my_model_convert_keras2tensorflow(keras_model_path, custom_objects=custom_objects, out_dir=None, out_pb_filename=None)
# my_model_tools.my_save_graph_to_tensorboard(backend.get_session(),'')
# my_model_tools.my_save_tensor_name_to_file(backend.get_session(),'')
