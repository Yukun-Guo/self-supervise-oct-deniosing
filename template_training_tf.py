...
data_size = (320, 256)
# create dataset
bscan_list = utils.listFiles('./data/Bscans_temp','*.png')
...
# create model 
# with strategy.scope():
my_model = UNet2D(in_size=data_size,in_channels=1,out_channels=1,output_activation='sigmoid', restore_model=False)  
